...
> let mediaEscolar = 7
undefined
> if (mediaAluno >= mediaEscolar) {console.log("Parabéns, você está aprovado, aproveite suas férias!")} else {console.log("Reprovados :(")}
Parabéns, você está aprovado, aproveite suas férias!
undefined
> mediaAluno = 6
6
> if (mediaAluno >= mediaEscolar) {console.log("Parabéns, você está aprovado, aproveite suas férias!")} else {console.log("Reprovados :(")}
