...
*/
let idade = parseInt(window.prompt("Insira sua idade em anos: "));
     if (idade >= 18){
            alert("Maior que 18 - autorizado")
     }
     else {
      alert("Menor que 18 - não autorizado")   
     }
/*  
...
*/
let idade = parseInt(window.prompt("Insira idade em anos: "));
     if (idade <= 18){
...
/* 
    ...
    Faça as comparações necessarias usando if e else if e els, para determinar qual a 
    interpretação do IMC atual.
...
let peso = parseFloat(window.prompt("Insira seu peso em kg: "));
let altura = parseFloat(window.prompt("Insira sua autura em metros: "));
