...
let saldoPorquinho = 798;
let valorNota = 5;

// item a)
let trocoMoeda = saldoPorquinho % valorNota;
console.log(trocoMoeda) // resultado = 3

//item b)
let qtdeNota = saldoPorquinho / valorNota;
console.log(qtdeNota); // Resultado = 159,6 (falta tornar nnúmero inteiro)
