...
if(age>=18){alert("Maior que 18 - Autorizado")}else{alert("Menor que 18 - NÃO autorizado")}
...
*/
let age = 25
if(age<=18){alert("Criança/Adolescente")}else if(age>18 && age<=60){alert("Adulto")}else{alert("Idoso")} 
//Adulto
...
if(imc<=18.5){alert("Abaixo do peso normal")} else if(imc > 18.5 && imc <= 25){alert("Peso Normal")} else if(imc > 25 && imc <=30){alert("Acima do peso")} else{alert("Obesidade")}
