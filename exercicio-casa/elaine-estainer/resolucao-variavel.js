...
*/
let name = "Elaine"
let profession = "Programadora em construção"
let school = "Superior Completo"
let state = "São Paulo"
let city = "São Bernardo do Campo"
console.log( name, profession, school, state, city); //Elaine Programadora em construção Superior Completo São Paulo São Bernardo do Campo
...
state = "Inglaterra"
city = "Londres"
console.log( name, profession, school, state, city); //Ada Lovelace Programadora Superior Completo Inglaterra Londres
...
const A = 100
A = 80
//Não funcionou, pois, a constante não permite que seu valor seja alterado
...
*/
let valor = 3000 /*VARIÁVEL*/
const taxa = 0.03 /*CONSTANTE*/
console.log(valor + (valor*taxa)) /*CONSOLE*/
// 3090